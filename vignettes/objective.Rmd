...
This vignette will explore the different ways to define the objective function. It does not assume any prior knowledge of the package.
...
```{r}
lp <- easylp$new()
lp$var("x", rows = letters[1:5], cols = 1:3)
